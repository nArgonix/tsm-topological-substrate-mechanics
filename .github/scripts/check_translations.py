...
def main():
    ...
    # Pancerne markery: rozbite ciągi tekstowe, niewykrywalne dla masowej zamiany w edytorach
    ZNACZNIK_START = "<" + "!-- START_TRANSLATION_STATUS --" + ">"
    ZNACZNIK_STOP = "<" + "!-- END_TRANSLATION_STATUS --" + ">"
