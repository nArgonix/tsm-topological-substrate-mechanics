# Topologiczna Mechanika Substratu

*Oto propozycja nowego, mechanicznego opisu rzeczywistości, który pozwala w prosty sposób wyjaśnić najważniejsze wnioski płynące z Ogólnej Teorii Względności oraz Modelu Standardowego. Opierając się na dekadach danych eksperymentalnych, TSM (Topological Substrate Mechanics) nie próbuje na siłę łączyć tych dwóch teorii na ich obecnym poziomie. Zamiast tego schodzi piętro niżej – do głębokiej mechaniki świata mikro – i stamtąd naturalnie wyprowadza znane nam zjawiska, such jak spowalnianie czasu czy prędkość światła $c$.*

*Według TSM prędkości większe od $c$ są jak najbardziej możliwe, ale w czwartym wymiarze przestrzennym. W naszym trójwymiarowym świecie prędkość $c$ określa po prostu największą prędkość propagacji znanych nam fal i zaburzeń. Na najgłębszym, mikroskopowym poziomie pierwotne 0-Cząstki mogą drgać z prędkościami o wiele większymi ($v \gg c$). Co więcej, TSM diametralnie upraszcza dotychczasowy Model Standardowy – całkowicie eliminuje potrzebę zakładania istnienia wielu różnych, niezależnych Cząstek czy fundamentalnych sił oddziaływań. Pokazuje bowiem, że wszystko, co obserwujemy, sprowadza się do odmiennych kształtów, drgań i odkształceń jednego, wspólnego ośrodka. Prawa fizyki relatywistycznej wyłaniają się dopiero wyżej, jako zbiorowy efekt działania całej osnowy. TSM zbiera najważniejsze osiągnięcia nauki i przekłada skomplikowane równania matematyczne na uniwersalny, zrozumiały dla każdego język mechaniki odkształceń i zderzeń.*
